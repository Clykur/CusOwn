...
export const ROUTES = {
  ...
  OWNER_BUSINESS_SETUP: (businessId: string) =>
    `/owner/businesses/${businessId}/setup`,
...
export const getSecureOwnerDashboardUrlClient = async (
  bookingLink: string,
): Promise<string> => {
  return getSecureResourceUrlClient("owner-dashboard", bookingLink);
};

export const getSecureBookingUrlClient = async (
  bookingLink: string,
): Promise<string> => {
  return getSecureResourceUrlClient("booking", bookingLink);
};

export const getSecureBookingStatusUrlClient = async (
  bookingId: string,
): Promise<string> => {
  return getSecureResourceUrlClient("booking-status", bookingId);
};

export const getSecureAcceptUrlClient = async (
  bookingId: string,
): Promise<string> => {
  return getSecureResourceUrlClient("accept", bookingId);
};

export const getSecureRejectUrlClient = async (
  bookingId: string,
): Promise<string> => {
