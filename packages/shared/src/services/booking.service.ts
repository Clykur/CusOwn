...
import { ERROR_MESSAGES, BOOKING_STATUS, BOOKING_LIST_MAX_PAGE_SIZE } from '@cusown/config';
...
export class BookingService {
  ...
  async createBookingIdempotentReserve(params: CreateBookingRpcParams): Promise<Booking> {
    const supabaseAdmin = requireSupabaseAdmin();
