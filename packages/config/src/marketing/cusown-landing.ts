export const CUSOWN_LANDING_PEXELS_VIDEO_URL =
  "https://player.vimeo.com/external/494252666.hd.mp4?s=2f5c7604473873499426f30a969a531d054f0a2e&profile_id=175" as const;
...
export function cusownAnnualBilledInr(): number {
  return Math.round(
    CUSOWN_PRICING.annualListInr *
      (1 - CUSOWN_PRICING.annualDiscountPercent / 100),
  );
}
