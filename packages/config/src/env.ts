...
const envSchema = z.object({
  ...
  NEXT_PUBLIC_APP_URL: z.preprocess(trimmedOrUndefined, z.string().url().default('http://localhost:3000')),
  NEXT_PUBLIC_MARKETING_URL: z.preprocess(trimmedOrUndefined, z.string().url().default('http://localhost:3001')),
...
export const env = {
  ...
  app: {
    ...
    marketingUrl: rawEnv.NEXT_PUBLIC_MARKETING_URL,
  },
  cron: {
