...
export const API_ROUTES = {
  ...
  BOOK_BUSINESS: (slug: string) =>
    `/api/book/business/${encodeURIComponent(slug)}`,
...
export const ERROR_MESSAGES = {
  ...
  BOOKING_LINK_EXISTS:
    "Booking link already exists. Please try a different salon name",
  ...
  CANCELLATION_TOO_LATE:
    "Cancellation must be at least 2 hours before appointment",
  ...
  IDEMPOTENCY_KEY_REQUIRED:
    "Idempotency key required: send x-idempotency-key header",
  ...
  OUTSTANDING_PAYMENTS_BLOCK:
    "User has outstanding payments; resolve before deletion",
...
export const UI_CONTEXT = {
  ...
  BUSINESS_RATING_REVIEWS: (avg: string, count: number) =>
    `${avg} ★ (${count} reviews)`,
  ...
  OWNER_DASHBOARD_SEARCH_PLACEHOLDER:
    "Search by name, booking ID, phone, business…",
  ...
  OWNER_ANALYTICS_PAGE_SUBTITLE:
    "Track business performance, growth, and key trends.",
  ...
  AUTH_LOGIN_DESC_CUSTOMER:
    "Access your bookings and book new appointments in one place.",
...
export const UI_CUSTOMER = {
  ...
  EXPLORE_FILTERS_SHEET_HINT:
    "Search salons, pick a location, or use your current position.",
...
export const UI_ERROR_CONTEXT = {
  ...
  DASHBOARD_PAGE:
    "Something went wrong. Try refreshing or return to dashboard.",
...
export const UI_LINK_EXPIRED = {
  ...
  MESSAGE:
    "This link has expired, has already been used, or is no longer valid.",
  NEXT_STEP:
    "Go to your dashboard to manage bookings, or ask the customer to send a new request.",
  CTA_HOME: "Go to home",
...
export const METRICS_CRON_EXPIRE_BOOKINGS_LAST_RUN =
  "cron.expire_bookings.last_run_ts";
...
export const METRICS_OBSERVABILITY_BOOKING_ATTEMPT_TOTAL =
  "observability.booking_attempt_total";
export const METRICS_OBSERVABILITY_BOOKING_SUCCESS_TOTAL =
  "observability.booking_success_total";
export const METRICS_OBSERVABILITY_CANCELLATION_TOTAL =
  "observability.cancellation_total";
export const METRICS_OBSERVABILITY_SLOT_CONFLICT_TOTAL =
  "observability.slot_conflict_total";
export const METRICS_OBSERVABILITY_CRON_HEALTH_STATUS =
  "observability.cron_health_status";
export const METRICS_BOOKING_DEADLOCK_RETRY_TOTAL =
  "booking_deadlock_retry_total";
...
export const METRICS_INVALID_STATE_TRANSITION_TOTAL =
...
export const REFUND_POLICY_NOTE =
  "Refunds follow payment provider policy and business discretion.";
...
export const AUDIT_FILTER_NOTES = {
  ...
  START_AFTER_END:
    "Start time must be before end time. Date range not applied.",
} as const;
...
export const AUDIT_STYLE_NEUTRAL =
...
export const METRICS_MEDIA_SIGNED_URL_DURATION_MS =
  "media.signed_url.duration_ms";
...
export const MEDIA_CACHE_CONTROL_HEADER =
