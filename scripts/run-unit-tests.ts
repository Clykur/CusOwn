...
const suites: Array<{ name: string; run: () => void | Promise<void> }> = [
  ...
  {
    name: "business discovery ranking",
    run: runUnitBusinessDiscoveryRankingTests,
  },
  { name: "reviews & ratings", run: runUnitReviewsTests },
  {
    name: "reschedule & cancellation rules",
    run: runUnitRescheduleCancellationTests,
  },
  {
    name: "recommendations & analytics",
    run: runUnitRecommendationsAnalyticsTests,
  },
  ...
  {
    name: "metrics reliability hardening",
    run: () => runMetricsReliabilityHardeningTests(),
  },
  ...
  {
    name: "lib/security/webhook-verification",
    run: runUnitWebhookVerificationTests,
  },
  { name: "lib/security/audit-pii-redact", run: runUnitAuditPiiRedactTests },
  { name: "lib/utils/response", run: runUnitResponseTests },
  {
    name: "lib/monitoring/lifecycle-structured-log",
    run: runUnitLifecycleStructuredLogTests,
  },
  {
    name: "lib/utils/secure-link-validation",
    run: runUnitSecureLinkValidationTests,
  },
