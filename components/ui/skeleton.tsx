...
/** Owner dashboard: content only (layout provides wrapper). Matches stats grid + Your Customers card + table. */
          ...
          <div className="border-t border-slate-200 pt-4">
            <div className="hidden lg:block">
              <div className="bg-slate-50 px-6 py-3 flex gap-4 border-b border-slate-200">
                {['Customer', 'Date & Time', 'Status', 'Booking ID', 'Business', 'Actions'].map(
                  (_, i) => (
...
/** Owner My Businesses: content only. Matches grid of business cards (2 columns on md+). */
...
/** Owner Create Business: content only. Matches single card with form fields. */
...
/** Owner Profile (embedded): content only. Matches profile sections. */
