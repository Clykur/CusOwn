...
const nextConfig = {
  ...
  webpack: (config, { isServer }) => {
    ...
    if (!isServer) {
      config.resolve.alias = {
        ...config.resolve.alias,
        '@cusown/shared/lib/supabase/server-auth': false,
        '@cusown/shared/lib/supabase/server': false,
        '@cusown/shared/lib/queue': false,
        bullmq: false,
        ioredis: false,
      };
    }
  ...
  transpilePackages: ['@cusown/shared', '@cusown/config'],
  async rewrites() {
    return [];
  },
};
