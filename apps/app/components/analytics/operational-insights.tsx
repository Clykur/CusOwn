    ...
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50/70 p-3">
          ...
          <StatusDot
            status={insights?.failedBookings > 5 ? "warning" : "healthy"}
          />
        </div>
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50/70 p-3">
          <div>
            ...
            <div className="text-lg font-bold">
              {insights?.cronHealthy ? "OK" : "Problem"}
            </div>
          </div>
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50/70 p-3">
          <div>
            ...
            <div className="text-lg font-bold">
              {insights?.systemErrors ?? 0}
            </div>
          </div>
          <StatusDot
            status={insights?.systemErrors > 0 ? "warning" : "healthy"}
          />
        </div>
        ...
        <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50/70 p-3">
          <div>
            ...
            <div className="text-lg font-bold">
              {insights?.customerGrowth ?? "—"}
            </div>
          </div>
          <StatusDot
            status={insights?.customerGrowth > 0 ? "healthy" : "warning"}
          />
        </div>
      </div>
    </div>
