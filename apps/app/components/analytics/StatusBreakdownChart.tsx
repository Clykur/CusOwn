...
export default function StatusBreakdownChart({
  ...
  return (
    <div className="min-h-0 w-full min-w-0 overflow-hidden rounded-xl border border-border-primary bg-surface-card p-4 shadow-sm md:p-6">
      <h3 className="mb-1 text-sm font-semibold text-text-primary md:mb-4">
        Booking Status Breakdown
      </h3>
      <p className="mb-4 text-xs text-text-secondary md:hidden">Share of bookings by outcome.</p>
      <div className="flex flex-col items-stretch gap-5 sm:flex-row sm:items-start sm:gap-6">
        ...
        <div className="w-full sm:w-1/2 sm:min-w-0">
          <div className="rounded-lg border border-border-primary bg-surface-elevated p-3 md:border-0 md:bg-transparent md:p-0">
            <p className="text-[11px] font-semibold uppercase tracking-wide text-text-secondary">
              Total
            </p>
            <p className="text-2xl font-bold text-text-primary md:text-3xl">{total}</p>
          </div>
