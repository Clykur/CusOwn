  ...
  return (
    <div className="w-full pb-24 flex flex-col gap-6" aria-busy="true">
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-surface-card border border-border-primary rounded-lg p-6">
          ...
          <div className="border-t border-border-primary pt-4">
            <div className="hidden lg:block">
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div
                  key={i}
                  className="px-6 py-4 flex gap-4 border-b border-border-primary last:border-0"
                >
    ...
    <div className="flex w-full flex-col gap-4 pb-24 md:gap-6" aria-busy="true">
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-6">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="rounded-xl border border-border-primary/90 bg-surface-card p-4 md:rounded-lg md:p-6"
          >
...
export function OwnerSetupSkeleton() {
  return (
    <div className="w-full pb-24" aria-busy="true">
      <div className="bg-surface-card border border-border-primary rounded-lg p-6 md:p-8">
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-lg border border-border-primary bg-surface-elevated/50">
            ...
            <div className="divide-y divide-border-primary">{[1, 2, 3].map(fieldRow)}</div>
          </div>
          <div className="overflow-hidden rounded-lg border border-border-primary bg-surface-elevated/50">
            <div className="border-b border-border-primary bg-surface-card/90 px-4 py-3">
              <div className={`h-3 w-20 rounded ${skeletonBase}`} />
...
export function OwnerSalonDetailLoadingBody() {
  return (
    ...
    >
      ...
      <div className={`${cardShell} `}>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {[1, 2].map((i) => (
            <div
              key={i}
              className={`h-28 rounded-xl border border-border-primary ${skeletonBase}`}
            />
          ))}
        </div>
      </div>
      ...
      {/* Slots / Downtime card */}
      <div className="overflow-hidden rounded-2xl border border-border-primary/90 bg-surface-card shadow-[0_1px_3px_rgba(15,23,42,0.06)] ring-1 ring-border-focus/5 md:rounded-lg md:shadow-none md:ring-0">
      ...
      {/* Customer reviews */}
      <div className={`${cardShell} md:rounded-xl md:shadow-sm md:ring-1 md:ring-white/5`}>
