...
export const skeletonBase = 'bg-surface-elevated rounded skeleton-shimmer';
...
export function SkeletonCard() {
  return (
    <div className="bg-surface-card border border-border-primary rounded-lg p-6" aria-busy="true">
...
export function SkeletonTable() {
  return (
    <div
      className="bg-surface-card border border-border-primary rounded-lg overflow-hidden"
      aria-busy="true"
    >
...
export function SkeletonCardList() {
  return (
    <div className="space-y-4" aria-busy="true">
      {[1, 2, 3].map((i) => (
        <div key={i} className="bg-surface-card border border-border-primary rounded-lg p-4">
