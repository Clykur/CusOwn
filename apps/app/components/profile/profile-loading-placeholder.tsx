...
export function ProfileLoadingPlaceholder({ embedded = false }: { embedded?: boolean }) {
    ...
    return (
      ...
      >
        <div className="space-y-4 animate-pulse" role="status" aria-label="Loading profile">
          <div className="h-44 rounded-xl bg-surface-elevated" />
          <div className="h-36 rounded-xl bg-surface-elevated" />
          <div className="h-12 rounded-xl bg-surface-elevated lg:hidden" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-surface-card" aria-busy="true">
      <div className="w-full px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 space-y-2 animate-pulse">
          <div className="h-8 w-48 max-w-full rounded-lg bg-surface-elevated sm:h-9 sm:w-56" />
          <div className="h-4 w-full max-w-md rounded bg-surface-elevated" />
        </div>
        <div className="space-y-4 animate-pulse" role="status" aria-label="Loading profile">
