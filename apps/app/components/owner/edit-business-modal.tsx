...
interface EditBusinessModalProps {
  ...
  editSaving: boolean;
  onFormChange: (
    updater: (prev: EditBusinessFormData) => EditBusinessFormData,
  ) => void;
  onSave: () => void;
  onClose: () => void;
}
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, salon_name: e.target.value }))
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, owner_name: e.target.value }))
              }
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, opening_time: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, closing_time: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              value={
                editForm.concurrent_booking_capacity ??
                DEFAULT_CONCURRENT_BOOKING_CAPACITY
              }
              onChange={(e) =>
                onFormChange((f) => ({
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                value={editForm.city}
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, city: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
                maxLength={100}
              />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, pincode: e.target.value }))
              }
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              maxLength={10}
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, latitude: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, longitude: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, address_line1: e.target.value }))
              }
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              maxLength={300}
            />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, address_line2: e.target.value }))
              }
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              maxLength={300}
            />
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, state: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
                maxLength={100}
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  onFormChange((f) => ({ ...f, country: e.target.value }))
                }
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
                maxLength={100}
              />
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, postal_code: e.target.value }))
              }
              className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-900 focus:border-transparent"
              maxLength={20}
            />
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                onFormChange((f) => ({ ...f, address: e.target.value }))
              }
              rows={2}
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={
              ...
              editForm.whatsapp_number.length !==
                VALIDATION.WHATSAPP_NUMBER_MIN_LENGTH
            }
