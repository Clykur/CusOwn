...
export async function proxy(request: NextRequest) {
  ...
  const privatePrefixes = ['/dashboard', '/admin', '/customer', '/owner', '/profile', '/onboarding', '/setup'];
  ...
  const isPublicCustomerRoute = 
    (url.pathname.startsWith('/customer/') && !url.pathname.startsWith('/customer/dashboard') && !url.pathname.startsWith('/customer/bookings')) ||
