...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const existingPaymentForBooking = await paymentService.getPaymentByBooking(
      booking.id,
    );
    ...
    const calculatedAmount = paymentService.calculatePaymentAmount(
      totalPriceCents,
      paymentType,
    );
