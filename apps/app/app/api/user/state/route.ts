...
import { getServerUser, getUserState, errorResponse, successResponse } from '@cusown/shared/server';
...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[API:user:state] getUserState returned', { state: state?.state });
