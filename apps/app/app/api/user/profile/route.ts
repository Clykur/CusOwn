...
export async function GET(request: NextRequest) {
  try {
    ...
    const accountData = {
      ...
      email_confirmed: auth.user.email_confirmed_at !== null && auth.user.email_confirmed_at !== undefined,
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    const oldProfile = (await userService.getUserProfile(auth.user.id)) as unknown as Record<string, unknown> | undefined;
