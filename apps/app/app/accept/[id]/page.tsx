  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error || `Failed to confirm booking (${response.status})`,
        );
      }
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            The confirmation message has been opened in WhatsApp. The customer
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            Booking found but missing slot or salon information. Please contact
            support.
          </p>
        </div>
      </div>
