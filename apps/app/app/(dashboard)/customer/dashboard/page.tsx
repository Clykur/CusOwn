...
function StatsSection() {
  ...
  const isRefreshing = useCustomerBookingsStore((state: CustomerBookingsState) => state.isRefreshing);
...
export default function CustomerDashboardPage() {
  ...
  const isInitialLoad = useCustomerBookingsStore((state: CustomerBookingsState) => state.isInitialLoad);
  const shouldRefetch = useCustomerBookingsStore((state: CustomerBookingsState) => state.shouldRefetch);
  const setBookings = useCustomerBookingsStore((state: CustomerBookingsState) => state.setBookings);
  const setIsInitialLoad = useCustomerBookingsStore((state: CustomerBookingsState) => state.setIsInitialLoad);
  const setIsRefreshing = useCustomerBookingsStore((state: CustomerBookingsState) => state.setIsRefreshing);
  const setLastFetchedAt = useCustomerBookingsStore((state: CustomerBookingsState) => state.setLastFetchedAt);
