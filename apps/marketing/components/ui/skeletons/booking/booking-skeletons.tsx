...
export function BookingPageSkeleton() {
  return (
    <div className="w-full" aria-busy="true">
      <div className="bg-surface-card border border-border-primary rounded-2xl p-6 sm:p-8 shadow-sm skeleton-shimmer">
  ...
  return (
    ...
    >
      <div className="max-w-md w-full">
        ...
        <div className="bg-surface-card rounded-lg shadow-lg p-8 skeleton-shimmer">
