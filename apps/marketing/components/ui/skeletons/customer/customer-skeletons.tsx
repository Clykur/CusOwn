        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-surface-card rounded-xl shadow-md p-6 border border-border-primary skeleton-shimmer"
              >
          ...
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-surface-elevated border-2 border-border-primary rounded-2xl p-4 sm:p-6 skeleton-shimmer"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 max-w-5xl mx-auto">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="rounded-2xl border-2 border-border-primary p-8 skeleton-shimmer"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div
                key={i}
                className="bg-surface-card rounded-xl border-2 border-border-primary p-6 skeleton-shimmer"
              >
  ...
  return (
    <div className="min-h-screen bg-surface-elevated" aria-busy="true">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-surface-card rounded-2xl shadow-sm border border-border-primary overflow-hidden skeleton-shimmer">
