    ...
    <div className="space-y-8" aria-busy="true" aria-hidden="true">
      ...
      <section className="rounded-2xl border border-border-primary bg-surface-card p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className={`rounded-xl border border-border-primary p-5 ${skeletonBase}`}>
      ...
      <div className="space-y-8">
        ...
        <section className="rounded-2xl border border-border-primary bg-surface-card p-6 shadow-sm">
          ...
          <div className="overflow-hidden rounded-xl border border-border-primary">
            <div className="bg-surface-elevated px-5 py-3.5 flex gap-4">
              {[1, 2, 3, 4, 5, 6].map((i) => (
...
export function AdminAnalyticsSkeleton() {
  return (
    <div className="flex min-h-[calc(100vh-6rem)] flex-col space-y-8 pb-8" aria-busy="true">
      ...
      <section className="rounded-2xl border border-border-primary bg-gradient-to-br from-slate-50 to-white p-6 shadow-sm">
        <div className={`h-4 ${skeletonBase} w-48 rounded mb-4`} />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="rounded-xl border border-border-primary/80 bg-surface-card p-5 shadow-sm"
            >
              <div className={`h-3 ${skeletonBase} w-20 rounded mb-2`} />
      ...
      <section className="rounded-2xl border border-border-primary bg-surface-card p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
          {[1, 2, 3, 4, 5, 6, 7].map((i) => (
            <div
              key={i}
              className="rounded-xl border border-border-primary bg-surface-elevated/50 p-4"
            >
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <div className="rounded-xl border border-slate-100 bg-surface-elevated/50 p-5">
