          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Manage your appointments without complexity. Create your booking page in minutes, set your availability, and let the platform handle confirmations and reminders.
              </p>
              <ul className="space-y-2 text-sm text-gray-600 mb-6">
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-black mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 mb-4">
                Book appointments quickly and confidently. Find available slots, book instantly, and receive confirmations through your preferred channel.
              </p>
              <ul className="space-y-2 text-sm text-gray-600 mb-6">
                <li className="flex items-start">
                  <svg className="h-5 w-5 text-black mr-2 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-24 sm:py-32 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 max-w-4xl mx-auto">
            {/* Active: Salons */}
            <div className="bg-black text-white rounded-xl p-6 text-center hover:bg-gray-900 transition-colors cursor-pointer" onClick={() => router.push(ROUTES.SALON_LIST)}>
            ...
            {[
              {
                ...
                description: 'Customers can view and book available time slots in real-time, reducing phone calls and manual scheduling.',
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Automated booking confirmations and reminders sent directly to customers via WhatsApp for instant communication.',
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Generate unique QR codes for your business that customers can scan to access your booking page instantly.',
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Comprehensive dashboard to view all bookings, manage availability, and track your business performance.',
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Platform administrators can monitor system health, support businesses, and ensure smooth operations.',
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Role-based authentication ensures that business owners, customers, and admins have appropriate access levels.',
                icon: (
                  <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="text-lg text-gray-600">
              Simple steps for businesses and customers
            </p>
          </div>
            ...
            {[
              {
                ...
                description: 'Set up your business profile, define your services, and configure your availability in minutes.',
              },
              {
                step: '2',
                title: 'Customers book slots',
                description: 'Customers browse available time slots and book appointments instantly, without creating accounts.',
              },
              {
                step: '3',
                title: 'Owners confirm',
                description: 'Business owners review and confirm bookings through their dashboard, with full control over availability.',
              },
              {
                step: '4',
                title: 'Platform handles communication',
                description: 'Automated confirmations, reminders, and updates are sent to customers via their preferred channel.',
              },
            ].map((item, index) => (
            ...
            {[
              {
                ...
                description: 'Industry-standard authentication with role-based access control to protect your business data.',
                icon: (
              ...
              },
              {
                ...
                description: 'Automated messaging system ensures customers receive confirmations and reminders on time.',
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Platform architecture built to handle growth, from small businesses to large operations.',
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                description: 'Created with input from service businesses to solve real-world booking challenges.',
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-xl text-gray-200 mb-10 leading-relaxed">
              ...
              <br />
              <span className="text-gray-400">Free to start, simple to use, works on any device.</span>
            </p>
