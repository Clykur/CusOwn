...
export default function SetupPage() {
  ...
  const checkAuthAndState = useCallback(async () => {
    ...
    if (session?.user) {
      ...
      } else if (!stateResult.canAccessSetup && stateResult.redirectUrl && stateResult.redirectUrl !== ROUTES.SETUP) {
  ...
  const validateForm = (): string | null => {
    ...
    if (!formData.whatsapp_number.trim() || !/^[0-9]{10,15}$/.test(formData.whatsapp_number.replace(/[^0-9]/g, ''))) {
      ...
      <div className="min-h-screen bg-white flex">
        <div className="flex-1 lg:ml-64">
          <div className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
            <OnboardingProgress currentStep={3} totalSteps={3} steps={['Choose Role', 'Sign In', 'Create Business']} />
            <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 mt-4">
              <div className="text-center mb-6 md:mb-8">
                ...
                <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">🎉 Business Created Successfully!</h2>
                <p className="text-sm md:text-base text-gray-600">Your booking page is ready to share with customers</p>
              </div>
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <svg className="w-5 h-5 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="mt-3 text-xs text-gray-600">Share this link with customers or add it to your social media</p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700">Add to WhatsApp status, Instagram bio, or website</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="bg-blue-100 rounded-full p-1.5 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700">Accept or reject bookings from your dashboard</p>
                    </div>
                  </div>
                  </div>
                </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
        <div className="max-w-2xl mx-auto">
          <OnboardingProgress currentStep={2} totalSteps={3} steps={['Choose Role', 'Sign In', 'Create Business']} />
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 mt-6 text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Sign In to Create Your Business</h1>
            <p className="text-gray-600 text-lg mb-8">
              Sign in with Google to create and manage your booking page. Your account will be created automatically.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8">
            <div className="mb-6 text-center">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Set Up Your Booking Page</h2>
              <p className="text-gray-600 text-sm md:text-base">Fill in the details below. All fields marked with <span className="text-red-500">*</span> are required.</p>
            </div>
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-3 md:p-4 mb-4">
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <p className="text-xs md:text-sm text-blue-800">
                  <strong className="font-semibold">Tip:</strong> You can create multiple businesses later. Each business gets its own booking link and QR code.
                </p>
              </div>
            </div>

            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              <label htmlFor="salon_name" className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-900 mb-2">
              ...
              />
              <p className="mt-1.5 text-xs text-gray-600">This name will appear on your booking page</p>
            </div>

            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              <label htmlFor="owner_name" className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-900 mb-2">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              <label htmlFor="whatsapp_number" className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-900 mb-2">
              ...
              />
              <p className="mt-1.5 text-xs text-gray-600">Booking requests will be sent to this number via WhatsApp</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                <div>
                  <label htmlFor="opening_time" className="block text-xs font-medium text-gray-700 mb-1.5">
                    Opening Time
                  </label>
                  <input
                    type="time"
                ...
                <div>
                  <label htmlFor="closing_time" className="block text-xs font-medium text-gray-700 mb-1.5">
                    Closing Time
                  </label>
                  <input
                    type="time"
              ...
              <p className="mt-2 text-xs text-gray-600">Slots will be available during these hours</p>
            </div>

            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              <label htmlFor="slot_duration" className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-900 mb-2">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              <label htmlFor="location" className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-900 mb-2">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              />
              <p className="mt-1.5 text-xs text-gray-600">City or area where your business is located</p>
            </div>

            <div className="bg-gray-50 rounded-xl p-4 md:p-5 border border-gray-200">
              <label htmlFor="address" className="flex items-center gap-2 text-xs md:text-sm font-semibold text-gray-900 mb-2">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              />
              <p className="mt-1.5 text-xs text-gray-600">Complete address. Customers will receive a Google Maps link to this location.</p>
            </div>
