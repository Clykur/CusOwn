...
import { RedirectSkeleton, OwnerDashboardSkeleton } from '@/components/ui/skeleton';
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <div className="text-4xl font-bold text-gray-900">
                    {dashboardStats.totalBusinesses}
                  </div>
                </div>
          ...
          {dashboardStats.totalBookings > 0 && (
            <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6 mb-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-4">
                ...
                <div className="text-center p-3 lg:p-4 bg-gray-50 rounded-lg">
                  <div className="text-xl lg:text-2xl font-bold text-gray-900 mb-1">
                    {dashboardStats.rejectedBookings}
                  </div>
                  <div className="text-xs font-medium text-gray-600 uppercase tracking-wide">
                    Rejected
                  </div>
              ...
              <div className="grid gap-4 lg:gap-6 md:grid-cols-2 lg:grid-cols-3 mb-6">
                {businesses.map((business) => (
                  <Link
                    key={business.id}
                    href={
                      secureUrls.get(business.booking_link) ||
